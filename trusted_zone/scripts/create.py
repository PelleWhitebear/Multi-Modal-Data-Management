...
setup_logging("create_trusted.log")
...
def main():
    ...
    try:
        ...
        create_bucket(s3_client, TRUSTED_ZONE_BUCKET)
        create_sub_bucket(s3_client, TRUSTED_ZONE_BUCKET, JSON_SUB_BUCKET)
        create_sub_bucket(s3_client, TRUSTED_ZONE_BUCKET, MEDIA_SUB_BUCKET)
